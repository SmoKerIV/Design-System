...
function App() {
  const routes = [
    ...
    { title: 'Radio & Checks', path: '/rnc',img :'https://mdn.alipayobjects.com/huamei_7uahnr/afts/img/A*DzgiRbW3khIAAAAAAAAAAAAADrJ8AQ/original' },
    ...
    { title: 'Lists', path: '/Lists',img :'https://mdn.alipayobjects.com/huamei_7uahnr/afts/img/A*EYuhSpw1iSwAAAAAAAAAAAAADrJ8AQ/original' },
    ...
    { title: 'Divider Space', path: '/DividerSpace',img :'https://mdn.alipayobjects.com/huamei_7uahnr/afts/img/A*ZiJ3SbOH9SUAAAAAAAAAAAAADrJ8AQ/original' },
